...
class Store2 
    ...
    def products
        products = open(ENV['lcbo_store2_key'])
        ...
        products_data["result"].each do |product|
            ...
            store = Store.find_by(name: "St Clair & Bathurst")

            if store == nil 
                store = Store.new(name: "St Clair & Bathurst")
                store.address_line_1 = "396 St. Clair Ave. West"
                store.address_line_2 = nil 
                store.city = "Toronto"
                store.zipcode = "M5P3N3"
                store.phone_number = "(416) 653-0220"
